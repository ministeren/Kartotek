...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "kartotek" because\n';
  ...
  $wnd.__gwt_activeModules['kartotek'] = {
    'moduleName' : 'kartotek',
    'bindings' : function() {
      return {};
    }
 ...
 * "/kartotek.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['kartotek'].superdevmode = true;

  var expectedSuffix = '/kartotek.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + kartotek + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:kartotek';
  var devModeSessionKey = '__gwtDevModeSession:kartotek';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/kartotek/kartotek.nocache.js';
  ...
  $wnd.__gwt_activeModules['kartotek'].canRedirect = true;
  $wnd.__gwt_activeModules['kartotek'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/kartotek?user.agent=' + ua + '&_callback=' + callback;
